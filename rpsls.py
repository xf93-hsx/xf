...
def rpsls(choice_name):
    ...
    if player_number == comp_number:
	         ...
	         print("您赢了")
    if (player_number == 3 and comp_number == 0)or(player_number == 4 and comp_number== 0):
	         print("计算机赢了") 
    elif (player_number == 0 and comp_number==1)or(player_number  ==4 and comp_number== 1):
	         print("计算机赢了")   
    elif (player_number == 0 and comp_number==2)or(player_number == 1 and comp_number== 2):
	         print("计算机赢了")
    elif (player_number == 1 and comp_number==3)or(player_number == 2 and comp_number== 3):
	         print("计算机赢了")
    elif (player_number == 2 and comp_number==4)or(player_number == 3 and comp_number== 4):
	         print("计算机赢了")
